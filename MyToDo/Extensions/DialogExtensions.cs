...
namespace MyToDo.Extensions
{
    public static class DialogExtensions
    {
        ...
        /// <returns></returns>
        public static async Task<IDialogResult> Qusetion(this IDialogHostService dialogHost,
        ...
        /// <param name="aggregator"></param>
        /// <param name="action"></param>
        public static void SubscribeMessage(this IEventAggregator aggregator,Action<MessageModel> action,string filterName="Main")
        {
